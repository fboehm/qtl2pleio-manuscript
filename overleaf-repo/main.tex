...
\correspondingauthoraffiliation{Department of Biostatistics and
  ...
  Genetics-Biotechnology Center, 425 Henry Mall, Madson, WI 53706.
...
deserve mention. First, CAPE (Combinatorial Analysis of Pleiotropy and
Epistasis) is a strategy for identifying identifying higher-order
...
are. This difference in approach may be due to the difference in
mapping resolution, between humans GWAS and experimental crosses.
