...
For each of $b$ (generally 1000) bootstrap data sets, we
...
The two traits show a correlation of $-0.15$ (Figure~S\ref{fig:scatter}).

QTL analysis with the LOCO method, and using sex as an additive
covariate, showed multiple suggestive QTL for each
phenotypes (Figures~S\ref{fig:genomewide10}
and S\ref{fig:genomewide22}; Table~S\ref{table-peaks}). For our investigation of
